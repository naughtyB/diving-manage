...
import AppSiderMenu from './app-sider-menu/index';
          ...
          <Layout className="app-layout">
            ...
            >
              <div className="app-layout-logo">
                <div className="app-layout-logo_diving">
              ...
              <AppSiderMenu collapsed={this.state.collapsed}/>
            </Sider>
            <Layout>
              <Header className="app-layout-header" style={{ background: '#fff', padding: 0 }}>
                <Icon
...
const mapStateToProps = (state) => {
  return {
    loginState: state.manager.loginState
  }
}
